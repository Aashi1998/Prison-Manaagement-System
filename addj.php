...
<div id="login">
  <div class="login">
<form class="reg1" action="addj1.php" method="post">
<div class="row">
<label>JID: <input type="text" name="jid" maxlength="3" required style="padding: 10px 55px;" /> </label> </br></br>
</div>
<div class= "row">
...
<div class= "row">
<label>Address: <input type="text" name="add" maxlength="50" required  style="padding: 10px 37px;" /> </label> </br></br>
</div>
<div class= "row">
...
<input class="login1" type="submit" name="addg" value="ADD"/></br> </br> 
</form>
</div>
</div>
